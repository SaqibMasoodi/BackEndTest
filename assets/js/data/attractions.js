...
import gondolaImg from '../../images/home/attractions/gondola.webp';
import waterfallImg from '../../images/home/attractions/waterfall.webp';
            ...
            <div class="p-8 lg:p-10 h-full flex flex-col">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="group relative overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 aspect-[4/3]">
                        <img src="${gondolaImg}" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Snowmobile">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:shadow-md transition-all group">
                        <div class="h-32 rounded-lg bg-slate-200 dark:bg-slate-800 mb-4 overflow-hidden">
                            <img src="${waterfallImg}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Waterfall">
                        </div>
